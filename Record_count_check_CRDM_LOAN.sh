...
ls -a CRDM_LOAN_MEMO_*_LN.CSV > CRDM_LOAN_MEMO_File_I.txt

chmod 777 CRDM_LOAN_MEMO_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_LOAN_MEMO_*_LN.CSV > CRDM_LOAN_MEMO_File_T.txt

chmod 777 CRDM_LOAN_MEMO_File_T.txt
