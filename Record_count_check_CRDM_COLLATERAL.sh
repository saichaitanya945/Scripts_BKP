...
ls -a CRDM_COLLATERAL_*_CI.CSV > CRDM_COLLATERAL_File_I.txt

chmod 777 CRDM_COLLATERAL_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_COLLATERAL_*_CI.CSV > CRDM_COLLATERAL_File_T.txt

chmod 777 CRDM_COLLATERAL_File_T.txt
