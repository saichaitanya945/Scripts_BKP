...
ls -a CRDM_CLIENTS_CONFORME_*_CI.CSV > CRDM_CLIENTS_CONFORME_File_I.txt

chmod 777 CRDM_CLIENTS_CONFORME_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_CLIENTS_CONFORME_*_CI.CSV > CRDM_CLIENTS_CONFORME_File_T.txt

chmod 777 CRDM_CLIENTS_CONFORME_File_T.txt
