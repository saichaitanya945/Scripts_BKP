...
ls -a CRDM_ACCOUNT_C??L_*_LN.CSV > CRDM_ACCOUNT_COLL_File_I.txt

chmod 777 CRDM_ACCOUNT_COLL_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_ACCOUNT_C??L_*_LN.CSV > CRDM_ACCOUNT_COLL_File_T.txt

chmod 777 CRDM_ACCOUNT_COLL_File_T.txt

##----------------------------------------

cd /mnt/Staging/LMS/CRDM/Input/ICBS 

ls -a CRDM_ACCOUNT_*_LN.CSV > CRDM_ACCOUNT_File_I.txt

chmod 777 CRDM_ACCOUNT_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_ACCOUNT_*_LN.CSV > CRDM_ACCOUNT_File_T.txt

chmod 777 CRDM_ACCOUNT_File_T.txt
