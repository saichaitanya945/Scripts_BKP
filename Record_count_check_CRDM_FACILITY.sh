...
ls -a CRDM_FACILITY_*_CI.CSV > CRDM_FACILITY_File_I.txt

chmod 777 CRDM_FACILITY_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_FACILITY_*_CI.CSV > CRDM_FACILITY_File_T.txt

chmod 777 CRDM_FACILITY_File_T.txt
