...
ls -a CRDM_CUSTOMER_*_CI.CSV > CRDM_CUSTOMER_File_I.txt

chmod 777 CRDM_CUSTOMER_File_T.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_CUSTOMER_*_CI.CSV > CRDM_CUSTOMER_File_T.txt
...
ls -a CRDM_CUSTOMER_A??T_*_CI.CSV > CRDM_CUSTOMER_ACCT_File_I.txt

chmod 777 CRDM_CUSTOMER_ACCT_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_CUSTOMER_A??T_*_CI.CSV > CRDM_CUSTOMER_ACCT_File_T.txt

chmod 777 CRDM_CUSTOMER_ACCT_File_T.txt

##-------------------------------------------------------------------------

cd /mnt/Staging/LMS/CRDM/Input/ICBS 

ls -a CRDM_CUSTOMER_R?L_*_CI.CSV > CRDM_CUSTOMER_REL_File_I.txt

chmod 777 CRDM_CUSTOMER_REL_File_I.txt

cd /mnt/Staging/LMS/CRDM/Input/Transact 

ls -a CRDM_CUSTOMER_R?L_*_CI.CSV > CRDM_CUSTOMER_REL_File_T.txt

chmod 777 CRDM_CUSTOMER_REL_File_T.txt
